    ...
    return (
      <Carousel className="w-75 p-3">
        <Carousel.Item>
          ...
          <a href="https://www.bonappetit.com/recipe/vegetarian-bean-chili-with-fritos"><h3>Vegetarian Chili With Lots of Fritos</h3></a>
        ...
        <Carousel.Item>
          <a href="https://www.bonappetit.com/recipe/jalapeno-cornbread-with-dairy-free-cilantro-lime-honey-butter"><img
            className="d-block w-100"
            src="https://foodly-mvp.s3-us-west-1.amazonaws.com/foodly_carousels_002.jpg"
            alt="Second slide"
          /></a>
          <StyledCarouselCaption>
          <a href="https://www.bonappetit.com/recipe/jalapeno-cornbread-with-dairy-free-cilantro-lime-honey-butter"><h3>Jalapeño Cornbread with Dairy-Free Cilantro-Lime Honey Butter</h3></a>
        ...
        <Carousel.Item>
          <a href="https://www.bonappetit.com/recipe/jamaican-beef-patties"><img
            className="d-block w-100"
            src="https://foodly-mvp.s3-us-west-1.amazonaws.com/foodly_carousels_003.jpg"
            alt="Third slide"
          /></a>
          <StyledCarouselCaption>
          <a href="https://www.bonappetit.com/recipe/jamaican-beef-patties"><h3>Jamaican Beef Patties</h3></a>
        ...
        <Carousel.Item>
          <a href="https://www.bonappetit.com/recipe/tropical-trifle-with-coconut-and-rum"><img
            className="d-block w-100"
            src="https://foodly-mvp.s3-us-west-1.amazonaws.com/foodly_carousels_004.jpg"
            alt="Fourth slide"
          /></a>
          <StyledCarouselCaption>
          <a href="https://www.bonappetit.com/recipe/tropical-trifle-with-coconut-and-rum"><h3>Tropical Trifle With Coconut and Rum</h3></a>
            <StyledCarouselParagraph>Creamy, sweet Ataulfo mangoes are ideal for this simple, vibrant dessert.</StyledCarouselParagraph>
          </StyledCarouselCaption>
        </Carousel.Item>
        <Carousel.Item>
          <a href="https://www.bonappetit.com/recipe/warm-winter-vegetable-salad-with-halloumi"><img
            className="d-block w-100"
            src="https://foodly-mvp.s3-us-west-1.amazonaws.com/foodly_carousels_005.jpg"
            alt="Fifth slide"
          /></a>
          <StyledCarouselCaption>
          <a href="https://www.bonappetit.com/recipe/warm-winter-vegetable-salad-with-halloumi"><h3>Warm Winter Vegetable Salad With Halloumi</h3></a>
        ...
        <Carousel.Item>
          <a href="https://www.bonappetit.com/recipe/mole-spiced-ribs-with-orange-and-pickled-onion"><img
            className="d-block w-100"
            src="https://foodly-mvp.s3-us-west-1.amazonaws.com/foodly_carousels_006.jpg"
            alt="Sixth slide"
          /></a>
          <StyledCarouselCaption>
          <a href="https://www.bonappetit.com/recipe/mole-spiced-ribs-with-orange-and-pickled-onion"><h3>Mole-Spiced Ribs With Orange and Pickled Onion</h3></a>
